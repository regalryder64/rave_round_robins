...
Preprocess: rave preprocess --input_path mediumsnare_wav --output_path output --num_signal 65536
Train: rave train --config v2_small --db_path output_large --name large_run --val_every 2000 --channels 1 --save_every 10000 --batch 2 --n_signal 65536
Tensorboard: tensorboard --logdir runs
Use the tensorboard to monitor training, including listening to the audio in the audio tab
Resume training: rave train --config v2_small --db_path output_large --name large_run --val_every 2000 --channels 1 --save_every 10000 --batch 2 --n_signal 65536 --ckpt runs/large_run_blahblah/version_blahblah/checkpoints/epoch_blah.ckpt
...
Export: rave export --run runs/large_run_blahblah --ckpt runs/large_run_blahblah/version_blahblah/checkpoints/epoch_blahblah.ckpt
